...
Pienso que puede tener el potencial para poder utilizarse en un modelo de árbol de decisiones, pero en su estado actual no creo que pueda lograrlo, principalmente porque el [proyecto en cuestión][https://github.com/Morche17/legalmente] está pensado para utilizar un motor de inferencia basado en la resolución SLD, los valores que estamos utilizando no son numéricos (aunque existen algunos valores numéricos en cuestión de costos, tiempos, vigencias, etc), habría que realizar adaptaciones como tal vez identificadores numéricos para cada palabra o asignarles un valor matemático, tal vez sólo así pueda aplicar como utilizable en un modelo de árbol de decisiones.
